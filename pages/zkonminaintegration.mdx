...
<Callout emoji="❗">
  We don't actually support import external deps other than the ones from zkon-zkapp and the o1.js. We're working on upgrading this.
</Callout>
...
<Callout emoji="⚠️">
  **For devnet** there is no need to prepay for the requests.
</Callout>
