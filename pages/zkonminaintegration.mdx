...
> ❗ **Important note:** We don't actually support import external deps other than the ones from zkon-zkapp and the o1.js. We're working on upgrading this.
...
<div style="border:1px solid black; padding: 10px;">
  <p>📝 <strong>Note:</strong> For devnet there is no need to prepay for the requests.</p>
</div>
